...
[
	...
	'middleware' => [ 'localeSessionRedirect', 'localizationRedirect', 'localeViewPath' ]
	 ...
	 Route::group(['namespace' => 'Home'], function(){
        ...
        // user profile
        Route::resource('profiles', 'ProfileController')->middleware('auth:cliants');
        ...
        Route::get('login/{provider}', 'AuthController@redirect')->where('provider','facebook|google|twitter')->name('');
        ...
        Route::get('How-Useage/{id}', 'WelcomeController@how_useage')->name('How-Useage');
        ...
        Route::get('order.pay.store', 'OrderController@paystore')->name('order.pay.store');
        ...
        Route::get('ConvertStars' , 'StarsController@ConvertStars')->name('ConvertStars');

        // upload images 
        Route::get('/upload-images','SupportCartController@store')->name('Upload-Images');

        
        Route::get('/balance_bay','PurchaseController@balance_bay')->name('balance_bay');
