...
class CartController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $carts = Product::orderBy('sub_category_id')->when($request->search, function ($q) use ($request) {
    ...
    public function store(Request $request)
    {
        ...
        $carts->time_Subscrip    = ['ar' => $request_all['time_Subscrip'], 'en' => $request_all['time_Subscrip_en']];

        $carts->Subscrip_status  = $request->has('Subscrip_status');
    ...
    public function update(Request $request, Product $cart)
    {
        ...
        $cart->update([
            ...
            'time_Subscrip'   => ['ar' => $request->time_Subscrip,      'en' => $request->time_Subscrip_en],
            'Subscrip_status' => $request->has('Subscrip_status'),
