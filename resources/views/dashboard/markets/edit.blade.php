                ...
                <div class="col-sm-12">
                    ...
                    <form action="{{ route('dashboard.markets.update', $market->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label>balance type ar</label>
                            <input type="text" name="balance_type_ar" class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" value="{{ $market->getTranslation('balance_type', 'ar') }}">
                        ...
                        <div class="form-group">
                            <label>balance type en</label>
                            <input type="text" name="balance_type_en" class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" value="{{$market->getTranslation('balance_type', 'en') }}">
                            @if ($errors->has('balance'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('balance') }}</strong>
                                </span>
