                    ...
                    <form action="{{ route('dashboard.markets.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="balance_type_ar" class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" value="{{ old('balance') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="balance_type_en" class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" value="{{ old('balance') }}">
                            @if ($errors->has('balance'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('balance') }}</strong>
                                </span>
