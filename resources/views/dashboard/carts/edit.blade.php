                ...
                <div class="col-sm-12">
                    ...
                    <form action="{{ route('dashboard.carts.update', $cart->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="balance" class="form-control{{ $errors->has('balance') ? ' is-invalid' : '' }}" value="{{ $cart->balance }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="amrecan_price" step="any" class="form-control{{ $errors->has('amrecan_price') ? ' is-invalid' : '' }}" value="{{ $cart->amrecan_price }}">
                        ...
                        <div class="form-check form-switch my-4">
                          <input class="form-check-input" value="1" name="Subscrip_status" type="checkbox"
                           id="flexSwitchCheckDefault" {{ $cart->Subscrip_status == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="time_Subscrip" class="form-control{{ $errors->has('time_Subscrip') ? ' is-invalid' : '' }}" value="{{ $cart->getTranslation('time_Subscrip', 'ar') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="time_Subscrip_en" class="form-control{{ $errors->has('time_Subscrip_en') ? ' is-invalid' : '' }}" value="{{ $cart->getTranslation('time_Subscrip', 'en') }}">
