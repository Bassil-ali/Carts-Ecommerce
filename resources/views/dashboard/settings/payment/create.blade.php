        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <form action="{{ route('dashboard.payment.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img src="{{ asset('uploads/payment_images/default.png') }}"  style="width: 100px" class="img-thumbnail image-preview" alt="">
                        </div>
