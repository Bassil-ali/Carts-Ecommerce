...
<body style="background:#F0F2F7;font-family: Cairo !important">
    <div class="box-latter" style=" width:30%;margin: auto;background: #F0F2F7;padding: 20px;">
        <div style="text-align: center;">
            ...
            <p style=" text-align:center; color: #777;padding: 0 40px;line-height: 1.5;">لقد اخترت تذكيرك عند توفر هذه البطاقة <a href="https://www.mjalstore.com/en/Contact-Us" target="_blank"> تواصل معنا</a></p>
        </div>
        <div  style="background:#fff !important;padding:20px;border-radius:10px;">
        	<div class="content-ing" style="margin-bottom:40px;text-align: center;">
            	<h2 style="text-align:center;font-size:19px;">{!!$product->cart_details->cart_name!!}<br>المتجر:{{$product->Market->name}}<br>{{$product->cart_details->short_descript}}</h2>
