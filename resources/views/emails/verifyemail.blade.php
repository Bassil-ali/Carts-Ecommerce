...
<body style="background:#F0F2F7;font-family: Cairo !important">
    <div class="box-latter" style=" width:30%;margin: auto;background: #F0F2F7;padding: 20px;">
        <div style="text-align: center;">
            ...
            <p style=" text-align:center; color: #777;padding: 0 40px;line-height: 1.5;">إذا كنت قد استلمت هذه الرسالة ولم تقم بإنشاء حساب فقط تجاهلها. تواجه أي مشكلة في تأكيد الحساب؟ <a href="http://https://www.mjalstore.com/en/Contact-Us" target="_blank"> تواصل معنا</a></p>
        </div>
        <div  style="background:#fff !important;padding:20px;border-radius:10px;">
        	<div class="content-ing" style="margin-bottom:40px;text-align: center;">
            	...
            	<div class="list-ing" style=" border-bottom: 1px solid #ececec;margin-bottom: 10px; padding-bottom: 10px;">
            		...
            		<a href="https://www.mjalstore.com/en/Email/{{$cliant->id}}/{{$cliant->code_email}}" style="overflow-wrap: break-word" target="_blank">https://www.mjalstore.com/en/Email/{{$cliant->id}}/{{$cliant->code_email}}</a>
            	</div>
            	<div>
