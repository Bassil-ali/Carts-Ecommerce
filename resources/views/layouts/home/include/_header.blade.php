    ...
    <div class="header-top">
        <div class="container">
            ...
            <ul class="topHmenu-left clearfix">
                ...
                @else
                <li class="dropdown">
                    <a href="product-page.html" data-toggle="dropdown">{{ Session::get('price_icon')}}</a>
                    <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                        ...
                        <li><a href="#">
                            <form action="{{ route('exchabges-rates') }}" method="get">
                                <input type="text" hidden value="SAR" name="rate">
                                <button type="">@lang('home.SAR')</button>
                            </form>
                        </a>
                        </li>
                    </li>
                    ...
                    <div class="clearfix">
                        <ul class="menu-purches clearfix">
                                            ...
                                            <div class="image-product">
                                                <div class="card-product">
                                                    <div class="" style="background: linear-gradient(180deg, {{ $item->model->sub_category->color_1 }} 0%, {{ $item->model->sub_category->color_2 }} 100%); border-radius: 10%">
                                                        <div class="">
                                                            <center>
                                                                <img alt="" src="{{ asset('uploads/cart_images/' . $item->model->cart_details->image)}}" width="100"/>
                                                            </center>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <li class="login-btn pro-btn dropdown">
                                @if (Auth::guard('cliants')->user()->provider != null)
                                    <img alt="" src="{{ asset('uploads/user_images/' . Auth::guard('cliants')->user()->image ) }}">
                                @else
                                    <img src="{{ Auth::guard('cliants')->user()->image }}" alt="">
                                @endif
                                    ...
                                    <ul aria-labelledby="dropdownMenu" class="dropdown-menu drop-profile multi-level" role="menu" style="">
                                        ...
                                        <li>
                                            <a href="" onclick="event.preventDefault(); document.getElementById('logout-client-form').submit();">
                                                @lang('home.logout')
                                            </a>
                                        </li>
                                        <form action="{{ route('logouts') }}" class="d-none" id="logout-client-form" method="POST">
                                            @csrf
                                        </form>
                                    </ul>
                                </img>
