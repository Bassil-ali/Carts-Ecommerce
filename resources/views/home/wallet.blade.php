                ...
                <div  class="content-ticit">
                    ...
                    <table class="table-site tabel-cart">
                      ...
                      <tr id="delete-cart-row{{ $item->id }}">
                        <td>
                            ...
                            <figure>
                                ...
                                <div  class="sec-title">
                                    ...
                                    <strong>  marcket:
                                        @if($item->model->market_id == null)
                                            none
                                        @else
                                            {{ $item->model->Market->name }}
                                        @endif
                                    </span>
                                    <strong>@lang('home.balance')<br> {{$item->model->balance}} 
                                        @if($item->model->market_id == null)
                                        @if ($item->model->Subscrip_status == 1)

                                        {{ $item->model->time_Subscrip }}
                                        @endif
                                        @else
                                        @if ($item->model->Subscrip_status == 1)
                                        ...
                                        {{ $item->model->time_Subscrip }}
                                        @else
                                            {{ $item->model->Market->balance_type }}
                                        @endif
                                        @endif</strong>
                        ...
                        <td><div  class="total-price{{ $item->rowId }}"><span>{{ Session::get('price_icon')}}</span> {{( $item->price  *  $item->qty)}}</div></td>
...
<section class="payment">
    @if (Auth::guard('cliants')->user()->isVerified != 1)
    <div class="not-mobail">
        <div class="sec-title">
            <img src="images/005-warning.svg" alt="" />
            <h2><a href="" data-target="#exampleModal" data-toggle="modal" style="color: #6f42c1;">@lang('home.no_phone')</a></h2>
        </div>
...
@if(!Auth::guard('cliants')->check())
    ...
    <div class="not-mobail">
        <div class="sec-title">
            <img src="images/005-warning.svg" alt="" />
            <h2><a href="" data-target="#exampleModal" data-toggle="modal" style="color: #6f42c1;">@lang('home.no_login')</a></h2>
        </div>
        <figure><img src="{{ asset('home_file/images/not-mobail.png') }}" alt="" /></figure>
    </div>
